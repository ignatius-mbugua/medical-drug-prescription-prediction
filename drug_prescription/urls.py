...
urlpatterns = [
    ...
    # prescription
    path('symptoms/create/', pre_views.symptoms_create, name='symptoms-create'),
    path('medicine-prescribed/', pre_views.prescribe_medicine, name='prescribe-medicine'),
    path('medicine-history/<int:id>', pre_views.prescriptions_history, name='prescription-history'),
